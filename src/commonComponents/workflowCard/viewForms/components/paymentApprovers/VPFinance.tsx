...
export interface IVPFinanceProps {
  self: any;
  context: WebPartContext;
  data: DataType;
}

export default class VPFinance extends React.Component<IVPFinanceProps, {}> {
  public componentDidMount(): void {}
  public render(): React.ReactElement<IVPFinanceProps> {
